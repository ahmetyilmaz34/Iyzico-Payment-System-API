...
const checkInstallments = () => {
    return Installments.checkInstallment({
        locale: Iyzipay.LOCALE.TR,
        conversationId: nanoid(), // İletişim idsi
        binNumber: "55287900", // Kartın başındaki sayıların 5 hanesi
        price: "1000"
    }).then((result) => {
        console.log(result);
...
const createPayment = () => {
    return Payments.createPayment({
        locale: Iyzipay.LOCALE.TR,
        conversationId: nanoid(), 
        price: "300", // total ödeme
        paidPrice: "300", // asıl ödenmesi gereken tutardır
        currency: Iyzipay.CURRENCY.TRY, // iyzipay içerisindeki enumarationlardan currency geliyor
        installment: "1", // taksitlendirme, installmentNumbers
        basketId: "B67JDL", // sepet içerisindeki ürünlerin kendi sistemimizdeki ürünün idsine işaret ediyor. Sİstemimizde bu idnin olması gerekir
        paymentChannel: Iyzipay.PAYMENT_CHANNEL.WEB,
        paymentGroup: Iyzipay.PAYMENT_GROUP.PRODUCT,
        paymentCard: { // ödeme yapacak kart bilgileri tanımlanıyor.
            cardHolderName: "John Doe",
            cardNumber: "5528790000000008",
            expireMonth: "12",
            expireYear: "2030",
            cvc: '123', // ödemeler için kullanabiliriz.
            registerCard: '0' // ödeme yapılan kart kaydetmiyor.
        },
        buyer: { // kullanıcı bilgileri tanımlanıyor.
            id: "SDFJKL", // kendi sistemimizdeki idyi buraya ekleyebiliriz. Kullanıcı idsidir.
            name: "John",
            surname: "Doe",
            gsmNumber: "+905350000000", // kullanıcının telefon numarası
            email: "email@email.com",
            identityNumber: "743008664791", // tc kimlik numarası
            lastLoginDate: "2020-10-05 12:43:35", // kullanıcının girdiği son tarih
            registrationDate: "2022-09-09 12:43:35", // kullanıcının kayıt tarihi
            registrationAddress: "Nidakule Göstepe, Merdivenkoy mah. Bora sk. No: 1", // kullanıcının adresi
            ip: "85.34.78.112", 
            city: "Istanbul",
            country: "Turkey",
            zipCode: "34732"
        },
        shippingAddress: { // fatura bilgileri tanımlanıyor
        ...
        billingAddress: { // kargolama bilgileri tanımlanıyor.
            contactName: "John Doe",
            city: "Istanbul",
            country: "Turkey",
            address: "Nidakule Göstepe, Merdivenkoy mah. Bora sk. No: 1",
        ...
        basketItems: [ // ürünleri barındıran dizidir.
            {
                id: "BT101", // ürün idisidir. Sistemdeki ürün idsi verilebilir.
                name: "Samsung s20",
                category1: "Telefonlar",
                category2: "Android Telefonlar",
                itemType: Iyzipay.BASKET_ITEM_TYPE.PHYSICAL, // fiziksel bir ürün olduğunu gösterir.
                price: 90 
            },
            {
                id: "BT102",
...
const createPaymentAndSaveCard = () => {
    return Payments.createPayment({
        ...
        paymentGroup: Iyzipay.PAYMENT_GROUP.PRODUCT,
        paymentCard: {
            cardUserKey: "nSCf5s8Z4BamQ43Cph1sLFZuuOI=", // kartın kaydedilmesi için kart idsi veriliyor.
            cardAlias: "Kredi Kartım Ödemeden Sonra", // kartın kaydedilme ismi
            cardHolderName: "John Doe",
            cardNumber: "5528790000000008",
            expireMonth: "12",
            expireYear: "2030",
...
const initializeThreeDSPayments = () => {
    PaymentsThreeDS.initializePayment({
        ...
        paymentChannel: Iyzipay.PAYMENT_CHANNEL.WEB,
        paymentGroup: Iyzipay.PAYMENT_GROUP.PRODUCT,
        callbackUrl: "https://localhost/api/payment/3ds/complete", //iyziconun bize döneceği istekdir.
        paymentCard: {
            cardHolderName: "John Doe",
            cardNumber: "5528790000000008",
            expireMonth: "12",
...
const initializeCheckoutForm = () => {
    Checkouts.initialize({
        ...
        cardUserKey: "nSCf5s8Z4BamQ43Cph1sLFZuuOI=",
        enableInstallments: [1,2,3,6,9], // taksitlendirmeler
        buyer: {
            id: "SDFJKL",
            name: "John",
            surname: "Doe",
...
const cancelPayments = () => {
    CancelPayments.cancelPayments({
        locale: Iyzipay.LOCALE.TR,
        conversationId: nanoid(),
        paymentId: "19232209",// ödeme idsi, bu ödemeyi iptal edeceğiz
        ip: "85.34.78.122"
    }).then((result) => {
        console.log(result);        
...
const cancelPaymentsWithReason = () => {
    CancelPayments.cancelPayments({
        locale: Iyzipay.LOCALE.TR,
        conversationId: nanoid(),
        paymentId: "19228790", // ödeme idsi, bu ödemeyi iptal edeceğiz
        ip: "85.34.78.122",
...
const refundPayment = () => {
    RefundPayments.refundPayments({
        locale: Iyzipay.LOCALE.TR,
        conversationId: nanoid(),
        paymentTransactionId: "20464124", //Gerçekleşen her bir ödeme altında farklı kalemlere(id) ayrılan ödemelerdir.
        price: "50",
        currency: Iyzipay.CURRENCY.TRY,
        ip: "85.34.78.112",
    }).then((result) => {
...
const refundPaymentWithReason = () => {
    RefundPayments.refundPayments({
        ...
        currency: Iyzipay.CURRENCY.TRY,
        ip: "85.34.78.112",
        reason: Iyzipay.REFUND_REASON.BUYER_REQUEST, // kullanıcı isteği ile iade etme işlemidir.
